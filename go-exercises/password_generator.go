...
Exercício 1 – Crie um gerador de senhas em Go. Seu algoritmo deve solicitar ao usuário quantos caracteres deve ter a senha e então gerar a senha de forma 
randômica usando caracteres e números.
